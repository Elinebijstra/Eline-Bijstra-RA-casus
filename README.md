...
De voorbereiding en voorbewerking van de [ruwe reumatoïde artritis data](Data/Raw) werden uitgevoerd in [Scripts/Mapping.R](Scripts/Mapping.R) Hierbij is het humane genoom (NCBI RefSeq: GCF_000001405.40) gebruikt als referentie. Vervolgens is op basis van BAM-bestanden een count matrix gegenereerd met [Scripts/Count_Matrix.R](Scripts/Count_Matrix.R) waarbij het referentiegenoom met accession number GCF_000001405.25-RS_2024_09 gebruikt is. Tot slot zijn op de gegenereerde count matrix statistische analyses uitgevoerd, waaronder een differentiële genexpressie analyse waaronder DESeq2 en een GO-Seq analyse, zoals beschreven in [Scripts/Statistiek_en_Analyse.R](Scripts/Statistiek_en_Analyse.R). Hierin is ook aan de hand van KEGG-pathway [hsa04658](https://www.kegg.jp/pathway/hsa04658) gekeken naar Th1- en Th2-celldifferentiatie. 
...
Tot slot is de differentiële genexpressie visueel weergegeven in een [volcano plot](Resultaten/VolcanoplotWC.png). De genen die rood zijn gekleurd laten een significante verandering in expressie (p-waarde <0,05) zien en geven een grote mate van up- of downregulated weer. De groen gekleurde genen hebben een expressieverandering, maar zonder statistische significantie. Er zijn 2058 genen significant omhoog gereguleerd en 2487 significant omlaag gereguleerd. 
